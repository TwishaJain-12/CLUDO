...
import SatelliteAuditViewer from '../components/SatelliteAuditViewer';
            ...
            <main className="container-custom py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {/* Satellite Audit Section - Only for environmental categories */}
                        {['deforestation', 'pollution', 'waste_management', 'water_quality'].includes(issue.category) && (
                            <div className="bg-dark-800 border border-dark-700 rounded-xl p-6">
                                <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
                                    <svg className="w-5 h-5 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    Satellite Environmental Audit
                                </h3>
                                <SatelliteAuditViewer issueId={id} location={issue.location} />
                            </div>
                        )}
